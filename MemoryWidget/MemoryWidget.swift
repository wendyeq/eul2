        ...
        ZStack {
            VStack(spacing: 8) {
                ...
                if entry.isValid {
                    HStack {
                        Group {
                            WidgetSectionView(title: "memory.usage".localized(), value: entry.used.widgetMemoryString)
                            WidgetSectionView(title: "memory.free".localized(), value: (entry.total - entry.used).widgetMemoryString)
                        }
