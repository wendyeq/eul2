...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func update() {
        ...
        let newAppUrl = URL(fileURLWithPath: arguments[1]).appendingPathComponent("eul2.app")
        let appUrl = URL(fileURLWithPath: arguments[2]).appendingPathComponent("eul2.app")
